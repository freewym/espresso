...
class SpeechLSTMModelConfig(FairseqDataclass):
    ...
    encoder_rnn_dropout_in: float = field(
        default=0.4, metadata={"help": "dropout probability for encoder rnn\'s input"}
    )
    encoder_rnn_dropout_out: float = field(
        default=0.4, metadata={"help": "dropout probability for encoder rnn\'s output"}
    )
    decoder_dropout_in: float = field(
        default=0.4, metadata={"help": "dropout probability for decoder input embedding"}
    )
    decoder_dropout_out: float = field(
        default=0.4, metadata={"help": "dropout probability for decoder output"}
    )
